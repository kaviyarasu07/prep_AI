...
export const searchMentorRequest = (payload) => ({
  type: SEARCH_MENTOR_REQUEST,
  payload, 
});

export const searchMentorSuccess = (data) => ({
  type: SEARCH_MENTOR_SUCCESS,
  payload: data,
});

export const searchMentorFailure = (error) => ({
