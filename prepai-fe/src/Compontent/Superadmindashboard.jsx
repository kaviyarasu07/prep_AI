  ...
  return (
    <div className="superadmin-dashboard" style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
      ...
      >
        ...
        <h4 className="mb-4 fw-bold text-white d-none d-md-block text-center">
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-2">
            <a 
              href="#" 
              className={`nav-link ${activeTab === "colleges" ? "active bg-light text-dark rounded" : "text-white"}`}
          ...
          <li className="nav-item mb-2">
            <a 
              href="#" 
              className={`nav-link ${activeTab === "logs" ? "active bg-light text-dark rounded" : "text-white"}`}
          ...
          <li className="nav-item mb-2">
            <a 
              href="#" 
              className={`nav-link ${activeTab === "settings" ? "active bg-light text-dark rounded" : "text-white"}`}
                  ...
                  <li key={idx} className="activity-item p-3 border-bottom">
                    <div className="d-flex align-items-start">
                      <div className={`flex-shrink-0 p-2 rounded-circle me-3 ${
                        act.type === "approve" ? "bg-success" : 
                        act.type === "reject" ? "bg-danger" : "bg-primary"
                      }`}>
                        {act.type === "approve" ? (
